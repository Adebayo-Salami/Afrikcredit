...
namespace AfikcreditData.Interfaces
{
    ...
    {
        bool Register(string email, string password, string accountNumber, string bankName, string referral, string ans1, string ans2, string ans3, out string message);
